...
class Drivetrain {
  ...
  private final int maxCalibrationFrames = 100; // The number of LL frames that will be averaged to determine the position of the robot when it is disabled() or being calibrated.
  private final int minCalibrationFrames = 1; // The minimum amount of LL frames that must be processed to accept a calibration.
